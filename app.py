...
def fetch_poster(movie_id):
    response = requests.get('https://api.themoviedb.org/3/movie/{}?api_key=d19b0bb18ef9e38f68d874aafd4fae92&language=en-US'.format(movie_id))
    data = response.json()
...
selected_movies_name  = st.selectbox(
    'Type which type of movies you want too see',
    movies['title'].values)
